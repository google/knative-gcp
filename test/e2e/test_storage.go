...
func CloudStorageSourceWithTestImpl(t *testing.T, assertMetrics, workloadIdentity bool, pubsubServiceAccount string) {
	...
	lib.MakeStorageOrDie(client, bucketName, storageName, targetName, pubsubServiceAccount)
