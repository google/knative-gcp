...
PUBSUBAPICOPY=("implements_test.go" "pullsubscription_conversion.go" "pullsubscription_conversion_test.go" "pullsubscription_defaults.go" "pullsubscription_defaults_test.go" "pullsubscription_lifecycle.go" "pullsubscription_lifecycle_test.go" "pullsubscription_types.go" "pullsubscription_validation.go" "pullsubscription_validation_test.go" "topic_conversion.go" "topic_conversion_test.go" "topic_defaults.go" "topic_defaults_test.go" "topic_lifecycle.go" "topic_lifecycle_test.go" "topic_types.go" "topic_validation.go" "topic_validation_test.go")
