...
type doReconcile func(ctx context.Context, o *v1beta1.PullSubscription) reconciler.Event
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1beta1.PullSubscription, desired *v1beta1.PullSubscription) error {
