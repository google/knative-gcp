...
import (
	...
	topic "github.com/google/knative-gcp/pkg/client/injection/reconciler/intevents/v1/topic"
...
//var _ topic.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ topic.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *inteventsv1.Topic) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *inteventsv1.Topic) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *inteventsv1.Topic) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *inteventsv1.Topic) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
