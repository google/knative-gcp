...
import (
	...
	brokerv1beta1 "github.com/google/knative-gcp/pkg/client/listers/broker/v1beta1"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister brokerv1beta1.BrokerLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister brokerv1beta1.BrokerLister, recorder record.EventRecorder, r Interface, classValue string, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.Broker, desired *v1beta1.Broker) error {
