...
import (
	...
	v1beta1broker "github.com/google/knative-gcp/pkg/client/injection/reconciler/broker/v1beta1/broker"
...
func NewController(
	...
	classFilter := reconciler.AnnotationFilterFunc(v1beta1broker.ClassAnnotationKey, classValue, false /*allowUnset*/)
