...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.EventPolicyBindings(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.EventPolicyBinding, desired *v1alpha1.EventPolicyBinding) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.SecurityV1alpha1().EventPolicyBindings(desired.Namespace)
		...
		updater := r.Client.SecurityV1alpha1().EventPolicyBindings(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.EventPolicyBinding) (*v1alpha1.EventPolicyBinding, error) {
	...
	getter := r.Lister.EventPolicyBindings(resource.Namespace)
	...
	patcher := r.Client.SecurityV1alpha1().EventPolicyBindings(resource.Namespace)
