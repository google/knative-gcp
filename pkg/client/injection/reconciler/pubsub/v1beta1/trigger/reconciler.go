...
type reconcilerImpl struct {
	...
	Lister pubsubv1beta1.TriggerLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pubsubv1beta1.TriggerLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.Trigger, desired *v1beta1.Trigger) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.PubsubV1beta1().Triggers(desired.Namespace)
		...
		updater := r.Client.PubsubV1beta1().Triggers(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.Trigger) (*v1beta1.Trigger, error) {
	...
	patcher := r.Client.PubsubV1beta1().Triggers(resource.Namespace)
