...
type reconcilerImpl struct {
	...
	Lister pubsubv1beta1.PullSubscriptionLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pubsubv1beta1.PullSubscriptionLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.PullSubscription, desired *v1beta1.PullSubscription) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.PubsubV1beta1().PullSubscriptions(desired.Namespace)
		...
		updater := r.Client.PubsubV1beta1().PullSubscriptions(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.PullSubscription) (*v1beta1.PullSubscription, error) {
	...
	patcher := r.Client.PubsubV1beta1().PullSubscriptions(resource.Namespace)
