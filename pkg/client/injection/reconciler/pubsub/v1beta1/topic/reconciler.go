...
import (
	...
	pubsubv1beta1 "github.com/google/knative-gcp/pkg/client/listers/pubsub/v1beta1"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister pubsubv1beta1.TopicLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pubsubv1beta1.TopicLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.Topic, desired *v1beta1.Topic) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.PubsubV1beta1().Topics(desired.Namespace)
		...
		updater := r.Client.PubsubV1beta1().Topics(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.Topic) (*v1beta1.Topic, error) {
	...
	patcher := r.Client.PubsubV1beta1().Topics(resource.Namespace)
