...
type reconcilerImpl struct {
	...
	Lister pubsubv1alpha1.TopicLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pubsubv1alpha1.TopicLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	original, err := r.Lister.Topics(namespace).Get(name)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.Topic, desired *v1alpha1.Topic) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			existing, err = r.Client.PubsubV1alpha1().Topics(desired.Namespace).Get(desired.Name, metav1.GetOptions{})
			if err != nil {
				return err
			}
		}
		...
		_, err = r.Client.PubsubV1alpha1().Topics(existing.Namespace).UpdateStatus(existing)
		return err
	})
}
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Topic) (*v1alpha1.Topic, error) {
	...
	actual, err := r.Lister.Topics(resource.Namespace).Get(resource.Name)
	if err != nil {
		return resource, err
	}
	...
	resource, err = r.Client.PubsubV1alpha1().Topics(resource.Namespace).Patch(resource.Name, types.MergePatchType, patch)
	if err != nil {
