...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.Topic, desired *v1alpha1.Topic) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.PubsubV1alpha1().Topics(desired.Namespace)
		...
		updater := r.Client.PubsubV1alpha1().Topics(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Topic) (*v1alpha1.Topic, error) {
	...
	patcher := r.Client.PubsubV1alpha1().Topics(resource.Namespace)
