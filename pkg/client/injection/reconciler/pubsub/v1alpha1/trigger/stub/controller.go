...
import (
	...
	trigger "github.com/google/knative-gcp/pkg/client/injection/informers/pubsub/v1alpha1/trigger"
	v1alpha1trigger "github.com/google/knative-gcp/pkg/client/injection/reconciler/pubsub/v1alpha1/trigger"
...
func NewController(
	...
	r := &Reconciler{}
	impl := v1alpha1trigger.NewImpl(ctx, r)
