...
type reconcilerImpl struct {
	...
	Lister pubsubv1alpha1.TriggerLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pubsubv1alpha1.TriggerLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.Triggers(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.Trigger, desired *v1alpha1.Trigger) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.PubsubV1alpha1().Triggers(desired.Namespace)
		...
		updater := r.Client.PubsubV1alpha1().Triggers(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Trigger) (*v1alpha1.Trigger, error) {
	...
	patcher := r.Client.PubsubV1alpha1().Triggers(resource.Namespace)
