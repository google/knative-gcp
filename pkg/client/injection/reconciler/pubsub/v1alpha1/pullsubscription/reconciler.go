...
import (
	...
	pubsubv1alpha1 "github.com/google/knative-gcp/pkg/client/listers/pubsub/v1alpha1"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister pubsubv1alpha1.PullSubscriptionLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pubsubv1alpha1.PullSubscriptionLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	original, err := r.Lister.PullSubscriptions(namespace).Get(name)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.PullSubscription, desired *v1alpha1.PullSubscription) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			existing, err = r.Client.PubsubV1alpha1().PullSubscriptions(desired.Namespace).Get(desired.Name, metav1.GetOptions{})
			if err != nil {
				return err
			}
		}
		...
		_, err = r.Client.PubsubV1alpha1().PullSubscriptions(existing.Namespace).UpdateStatus(existing)
		return err
	})
}
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.PullSubscription) (*v1alpha1.PullSubscription, error) {
	...
	actual, err := r.Lister.PullSubscriptions(resource.Namespace).Get(resource.Name)
	if err != nil {
		return resource, err
	}
	...
	resource, err = r.Client.PubsubV1alpha1().PullSubscriptions(resource.Namespace).Patch(resource.Name, types.MergePatchType, patch)
	if err != nil {
