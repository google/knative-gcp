...
import (
	...
	channel "github.com/google/knative-gcp/pkg/client/injection/informers/messaging/v1beta1/channel"
	v1beta1channel "github.com/google/knative-gcp/pkg/client/injection/reconciler/messaging/v1beta1/channel"
...
func NewController(
	...
	r := &Reconciler{}
	impl := v1beta1channel.NewImpl(ctx, r)
