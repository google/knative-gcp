...
import (
	...
	messagingv1beta1 "github.com/google/knative-gcp/pkg/client/listers/messaging/v1beta1"
	zap "go.uber.org/zap"
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.Channel, desired *v1beta1.Channel) error {
