...
import (
	...
	channel "github.com/google/knative-gcp/pkg/client/injection/reconciler/messaging/v1alpha1/channel"
...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "ChannelReconciled", "Channel reconciled: \"%s/%s\"", namespace, name)
}
...
var _ channel.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ channel.Finalizer = (*Reconciler)(nil)
...
//var _ channel.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ channel.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.Channel) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.Channel) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.Channel) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.Channel) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
