...
const (
	defaultControllerAgentName = "httppolicybinding-controller"
	defaultFinalizerName       = "httppolicybindings.policy.run.cloud.google.com"
	defaultQueueName           = "httppolicybindings"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     httppolicybindingInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
