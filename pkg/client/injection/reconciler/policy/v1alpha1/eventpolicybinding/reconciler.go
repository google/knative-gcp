...
import (
	...
	policyv1alpha1 "github.com/google/knative-gcp/pkg/client/listers/policy/v1alpha1"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister policyv1alpha1.EventPolicyBindingLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister policyv1alpha1.EventPolicyBindingLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.EventPolicyBinding, desired *v1alpha1.EventPolicyBinding) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.PolicyV1alpha1().EventPolicyBindings(desired.Namespace)
		...
		updater := r.Client.PolicyV1alpha1().EventPolicyBindings(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.EventPolicyBinding) (*v1alpha1.EventPolicyBinding, error) {
	...
	patcher := r.Client.PolicyV1alpha1().EventPolicyBindings(resource.Namespace)
