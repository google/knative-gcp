...
import (
	...
	eventpolicybinding "github.com/google/knative-gcp/pkg/client/injection/informers/policy/v1alpha1/eventpolicybinding"
...
const (
	defaultControllerAgentName = "eventpolicybinding-controller"
	defaultFinalizerName       = "eventpolicybindings.policy.run.cloud.google.com"
	defaultQueueName           = "eventpolicybindings"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     eventpolicybindingInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
