...
import (
	...
	cloudauditlogssource "github.com/google/knative-gcp/pkg/client/injection/reconciler/events/v1/cloudauditlogssource"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *eventsv1.CloudAuditLogsSource) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *eventsv1.CloudAuditLogsSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *eventsv1.CloudAuditLogsSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *eventsv1.CloudAuditLogsSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
