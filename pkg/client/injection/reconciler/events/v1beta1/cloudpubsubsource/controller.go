...
const (
	defaultControllerAgentName = "cloudpubsubsource-controller"
	defaultFinalizerName       = "cloudpubsubsources.events.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := cloudpubsubsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "events.cloud.google.com.CloudPubSubSource"),
	)
