...
const (
	defaultControllerAgentName = "cloudschedulersource-controller"
	defaultFinalizerName       = "cloudschedulersources.events.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := cloudschedulersourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "events.cloud.google.com.CloudSchedulerSource"),
	)
