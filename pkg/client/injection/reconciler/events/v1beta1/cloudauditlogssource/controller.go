...
const (
	defaultControllerAgentName = "cloudauditlogssource-controller"
	defaultFinalizerName       = "cloudauditlogssources.events.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := cloudauditlogssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "events.cloud.google.com.CloudAuditLogsSource"),
	)
