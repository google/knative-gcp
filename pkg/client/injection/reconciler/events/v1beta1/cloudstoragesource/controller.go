...
const (
	defaultControllerAgentName = "cloudstoragesource-controller"
	defaultFinalizerName       = "cloudstoragesources.events.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := cloudstoragesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "events.cloud.google.com.CloudStorageSource"),
	)
