...
const (
	defaultControllerAgentName = "cloudbuildsource-controller"
	defaultFinalizerName       = "cloudbuildsources.events.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := cloudbuildsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "events.cloud.google.com.CloudBuildSource"),
	)
