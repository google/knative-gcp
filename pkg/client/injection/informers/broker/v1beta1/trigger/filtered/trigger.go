...
func Get(ctx context.Context, selector string) v1beta1.TriggerInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/google/knative-gcp/pkg/client/informers/externalversions/broker/v1beta1.TriggerInformer with selector %s from context.", selector)
	}
