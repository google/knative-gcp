...
func Get(ctx context.Context, selector string) v1beta1.BrokerInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/google/knative-gcp/pkg/client/informers/externalversions/broker/v1beta1.BrokerInformer with selector %s from context.", selector)
	}
