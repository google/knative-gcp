...
func Get(ctx context.Context) v1alpha1.PubSubSourceInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Fatalf(
			"Unable to fetch %T from context.", (v1alpha1.PubSubSourceInformer)(nil))
	}
	return untyped.(v1alpha1.PubSubSourceInformer)
}
