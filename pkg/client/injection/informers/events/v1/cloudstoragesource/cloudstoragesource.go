...
func Get(ctx context.Context) v1.CloudStorageSourceInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/google/knative-gcp/pkg/client/informers/externalversions/events/v1.CloudStorageSourceInformer from context.")
	}
