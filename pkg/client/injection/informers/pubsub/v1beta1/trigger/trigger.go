...
func Get(ctx context.Context) v1beta1.TriggerInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/google/knative-gcp/pkg/client/informers/externalversions/pubsub/v1beta1.TriggerInformer from context.")
	}
