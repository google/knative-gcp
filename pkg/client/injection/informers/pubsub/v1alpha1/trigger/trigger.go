...
func withInformer(ctx context.Context) (context.Context, controller.Informer) {
	f := factory.Get(ctx)
	inf := f.Pubsub().V1alpha1().Triggers()
...
func Get(ctx context.Context) v1alpha1.TriggerInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/google/knative-gcp/pkg/client/informers/externalversions/pubsub/v1alpha1.TriggerInformer from context.")
	}
