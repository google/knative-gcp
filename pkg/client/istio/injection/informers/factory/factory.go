...
import (
	...
	externalversions "github.com/google/knative-gcp/pkg/client/istio/informers/externalversions"
	client "github.com/google/knative-gcp/pkg/client/istio/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/google/knative-gcp/pkg/client/istio/informers/externalversions.SharedInformerFactory from context.")
	}
