...
var triggersResource = schema.GroupVersionResource{Group: "pubsub.cloud.google.com", Version: "v1beta1", Resource: "triggers"}

var triggersKind = schema.GroupVersionKind{Group: "pubsub.cloud.google.com", Version: "v1beta1", Kind: "Trigger"}
...
func (c *FakeTriggers) UpdateStatus(trigger *v1beta1.Trigger) (*v1beta1.Trigger, error) {
	obj, err := c.Fake.
