...
var pullsubscriptionsResource = schema.GroupVersionResource{Group: "pubsub.cloud.google.com", Version: "v1beta1", Resource: "pullsubscriptions"}

var pullsubscriptionsKind = schema.GroupVersionKind{Group: "pubsub.cloud.google.com", Version: "v1beta1", Kind: "PullSubscription"}
...
func (c *FakePullSubscriptions) Get(name string, options v1.GetOptions) (result *v1beta1.PullSubscription, err error) {
	...
	return obj.(*v1beta1.PullSubscription), err
}
...
func (c *FakePullSubscriptions) List(opts v1.ListOptions) (result *v1beta1.PullSubscriptionList, err error) {
	...
	list := &v1beta1.PullSubscriptionList{ListMeta: obj.(*v1beta1.PullSubscriptionList).ListMeta}
	for _, item := range obj.(*v1beta1.PullSubscriptionList).Items {
