...
func (c *FakeCloudStorageSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudStorageSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudStorageSources) UpdateStatus(ctx context.Context, cloudStorageSource *v1alpha1.CloudStorageSource, opts v1.UpdateOptions) (*v1alpha1.CloudStorageSource, error) {
	obj, err := c.Fake.
