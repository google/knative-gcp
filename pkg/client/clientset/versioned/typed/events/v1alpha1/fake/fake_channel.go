...
var channelsResource = schema.GroupVersionResource{Group: "events.cloud.run", Version: "v1alpha1", Resource: "channels"}

var channelsKind = schema.GroupVersionKind{Group: "events.cloud.run", Version: "v1alpha1", Kind: "Channel"}
