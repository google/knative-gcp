...
func (c *FakeCloudSchedulerSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudSchedulerSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudSchedulerSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudSchedulerSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudSchedulerSources) UpdateStatus(ctx context.Context, cloudSchedulerSource *v1alpha1.CloudSchedulerSource, opts v1.UpdateOptions) (*v1alpha1.CloudSchedulerSource, error) {
	obj, err := c.Fake.
