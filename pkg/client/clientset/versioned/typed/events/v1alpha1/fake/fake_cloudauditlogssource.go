...
func (c *FakeCloudAuditLogsSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudAuditLogsSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudAuditLogsSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudAuditLogsSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudAuditLogsSources) Create(ctx context.Context, cloudAuditLogsSource *v1alpha1.CloudAuditLogsSource, opts v1.CreateOptions) (result *v1alpha1.CloudAuditLogsSource, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(cloudauditlogssourcesResource, c.ns, cloudAuditLogsSource), &v1alpha1.CloudAuditLogsSource{})
...
func (c *FakeCloudAuditLogsSources) Update(ctx context.Context, cloudAuditLogsSource *v1alpha1.CloudAuditLogsSource, opts v1.UpdateOptions) (result *v1alpha1.CloudAuditLogsSource, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(cloudauditlogssourcesResource, c.ns, cloudAuditLogsSource), &v1alpha1.CloudAuditLogsSource{})
...
func (c *FakeCloudAuditLogsSources) UpdateStatus(ctx context.Context, cloudAuditLogsSource *v1alpha1.CloudAuditLogsSource, opts v1.UpdateOptions) (*v1alpha1.CloudAuditLogsSource, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(cloudauditlogssourcesResource, "status", c.ns, cloudAuditLogsSource), &v1alpha1.CloudAuditLogsSource{})
