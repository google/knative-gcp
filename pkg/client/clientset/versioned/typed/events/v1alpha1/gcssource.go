...
type GCSSourceInterface interface {
	...
	UpdateStatus(*v1alpha1.GCSSource) (*v1alpha1.GCSSource, error)
...
func newGCSSources(c *EventsV1alpha1Client, namespace string) *gCSSources {
	return &gCSSources{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *gCSSources) UpdateStatus(gCSSource *v1alpha1.GCSSource) (result *v1alpha1.GCSSource, err error) {
	result = &v1alpha1.GCSSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gcssources").
