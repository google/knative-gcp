...
type CloudSchedulerSourceInterface interface {
	Create(ctx context.Context, cloudSchedulerSource *v1beta1.CloudSchedulerSource, opts v1.CreateOptions) (*v1beta1.CloudSchedulerSource, error)
	Update(ctx context.Context, cloudSchedulerSource *v1beta1.CloudSchedulerSource, opts v1.UpdateOptions) (*v1beta1.CloudSchedulerSource, error)
	UpdateStatus(ctx context.Context, cloudSchedulerSource *v1beta1.CloudSchedulerSource, opts v1.UpdateOptions) (*v1beta1.CloudSchedulerSource, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.CloudSchedulerSource, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.CloudSchedulerSourceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloudSchedulerSource, err error)
...
func (c *cloudSchedulerSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.CloudSchedulerSource, err error) {
...
func (c *cloudSchedulerSources) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.CloudSchedulerSourceList, err error) {
...
func (c *cloudSchedulerSources) Create(ctx context.Context, cloudSchedulerSource *v1beta1.CloudSchedulerSource, opts v1.CreateOptions) (result *v1beta1.CloudSchedulerSource, err error) {
	result = &v1beta1.CloudSchedulerSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudschedulersources").
...
func (c *cloudSchedulerSources) Update(ctx context.Context, cloudSchedulerSource *v1beta1.CloudSchedulerSource, opts v1.UpdateOptions) (result *v1beta1.CloudSchedulerSource, err error) {
	result = &v1beta1.CloudSchedulerSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudschedulersources").
...
func (c *cloudSchedulerSources) UpdateStatus(ctx context.Context, cloudSchedulerSource *v1beta1.CloudSchedulerSource, opts v1.UpdateOptions) (result *v1beta1.CloudSchedulerSource, err error) {
	result = &v1beta1.CloudSchedulerSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudschedulersources").
...
func (c *cloudSchedulerSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloudSchedulerSource, err error) {
	result = &v1beta1.CloudSchedulerSource{}
