...
func (c *FakeCloudBuildSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.CloudBuildSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudBuildSources) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.CloudBuildSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudBuildSources) Create(ctx context.Context, cloudBuildSource *v1beta1.CloudBuildSource, opts v1.CreateOptions) (result *v1beta1.CloudBuildSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudBuildSources) Update(ctx context.Context, cloudBuildSource *v1beta1.CloudBuildSource, opts v1.UpdateOptions) (result *v1beta1.CloudBuildSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudBuildSources) UpdateStatus(ctx context.Context, cloudBuildSource *v1beta1.CloudBuildSource, opts v1.UpdateOptions) (*v1beta1.CloudBuildSource, error) {
	obj, err := c.Fake.
...
func (c *FakeCloudBuildSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloudBuildSource, err error) {
	obj, err := c.Fake.
