...
type CloudStorageSourceInterface interface {
	Create(*v1beta1.CloudStorageSource) (*v1beta1.CloudStorageSource, error)
	Update(*v1beta1.CloudStorageSource) (*v1beta1.CloudStorageSource, error)
	UpdateStatus(*v1beta1.CloudStorageSource) (*v1beta1.CloudStorageSource, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.CloudStorageSource, error)
	List(opts v1.ListOptions) (*v1beta1.CloudStorageSourceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CloudStorageSource, err error)
...
func (c *cloudStorageSources) Get(name string, options v1.GetOptions) (result *v1beta1.CloudStorageSource, err error) {
...
func (c *cloudStorageSources) List(opts v1.ListOptions) (result *v1beta1.CloudStorageSourceList, err error) {
...
func (c *cloudStorageSources) Create(cloudStorageSource *v1beta1.CloudStorageSource) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudstoragesources").
...
func (c *cloudStorageSources) Update(cloudStorageSource *v1beta1.CloudStorageSource) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudstoragesources").
...
func (c *cloudStorageSources) UpdateStatus(cloudStorageSource *v1beta1.CloudStorageSource) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudstoragesources").
...
func (c *cloudStorageSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
