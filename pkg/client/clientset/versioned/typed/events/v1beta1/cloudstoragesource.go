...
type CloudStorageSourceInterface interface {
	Create(ctx context.Context, cloudStorageSource *v1beta1.CloudStorageSource, opts v1.CreateOptions) (*v1beta1.CloudStorageSource, error)
	Update(ctx context.Context, cloudStorageSource *v1beta1.CloudStorageSource, opts v1.UpdateOptions) (*v1beta1.CloudStorageSource, error)
	UpdateStatus(ctx context.Context, cloudStorageSource *v1beta1.CloudStorageSource, opts v1.UpdateOptions) (*v1beta1.CloudStorageSource, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.CloudStorageSource, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.CloudStorageSourceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloudStorageSource, err error)
...
func newCloudStorageSources(c *EventsV1beta1Client, namespace string) *cloudStorageSources {
...
func (c *cloudStorageSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cloudStorageSources) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.CloudStorageSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.CloudStorageSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cloudstoragesources").
...
func (c *cloudStorageSources) Create(ctx context.Context, cloudStorageSource *v1beta1.CloudStorageSource, opts v1.CreateOptions) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudstoragesources").
...
func (c *cloudStorageSources) Update(ctx context.Context, cloudStorageSource *v1beta1.CloudStorageSource, opts v1.UpdateOptions) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudstoragesources").
...
func (c *cloudStorageSources) UpdateStatus(ctx context.Context, cloudStorageSource *v1beta1.CloudStorageSource, opts v1.UpdateOptions) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudstoragesources").
...
func (c *cloudStorageSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloudStorageSource, err error) {
	result = &v1beta1.CloudStorageSource{}
