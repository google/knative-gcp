...
type CloudPubSubSourceInterface interface {
	Create(*v1beta1.CloudPubSubSource) (*v1beta1.CloudPubSubSource, error)
	Update(*v1beta1.CloudPubSubSource) (*v1beta1.CloudPubSubSource, error)
	UpdateStatus(*v1beta1.CloudPubSubSource) (*v1beta1.CloudPubSubSource, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.CloudPubSubSource, error)
	List(opts v1.ListOptions) (*v1beta1.CloudPubSubSourceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CloudPubSubSource, err error)
...
func (c *cloudPubSubSources) Get(name string, options v1.GetOptions) (result *v1beta1.CloudPubSubSource, err error) {
...
func (c *cloudPubSubSources) List(opts v1.ListOptions) (result *v1beta1.CloudPubSubSourceList, err error) {
...
func (c *cloudPubSubSources) Create(cloudPubSubSource *v1beta1.CloudPubSubSource) (result *v1beta1.CloudPubSubSource, err error) {
	result = &v1beta1.CloudPubSubSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudpubsubsources").
...
func (c *cloudPubSubSources) Update(cloudPubSubSource *v1beta1.CloudPubSubSource) (result *v1beta1.CloudPubSubSource, err error) {
	result = &v1beta1.CloudPubSubSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudpubsubsources").
...
func (c *cloudPubSubSources) UpdateStatus(cloudPubSubSource *v1beta1.CloudPubSubSource) (result *v1beta1.CloudPubSubSource, err error) {
	result = &v1beta1.CloudPubSubSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudpubsubsources").
...
func (c *cloudPubSubSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CloudPubSubSource, err error) {
	result = &v1beta1.CloudPubSubSource{}
