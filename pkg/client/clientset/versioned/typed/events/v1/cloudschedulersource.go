...
type CloudSchedulerSourceInterface interface {
	Create(*v1.CloudSchedulerSource) (*v1.CloudSchedulerSource, error)
	Update(*v1.CloudSchedulerSource) (*v1.CloudSchedulerSource, error)
	UpdateStatus(*v1.CloudSchedulerSource) (*v1.CloudSchedulerSource, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.CloudSchedulerSource, error)
	List(opts metav1.ListOptions) (*v1.CloudSchedulerSourceList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CloudSchedulerSource, err error)
...
func (c *cloudSchedulerSources) Get(name string, options metav1.GetOptions) (result *v1.CloudSchedulerSource, err error) {
...
func (c *cloudSchedulerSources) List(opts metav1.ListOptions) (result *v1.CloudSchedulerSourceList, err error) {
...
func (c *cloudSchedulerSources) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudSchedulerSources) Create(cloudSchedulerSource *v1.CloudSchedulerSource) (result *v1.CloudSchedulerSource, err error) {
	result = &v1.CloudSchedulerSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudschedulersources").
...
func (c *cloudSchedulerSources) Update(cloudSchedulerSource *v1.CloudSchedulerSource) (result *v1.CloudSchedulerSource, err error) {
	result = &v1.CloudSchedulerSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudschedulersources").
...
func (c *cloudSchedulerSources) UpdateStatus(cloudSchedulerSource *v1.CloudSchedulerSource) (result *v1.CloudSchedulerSource, err error) {
	result = &v1.CloudSchedulerSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudschedulersources").
...
func (c *cloudSchedulerSources) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *cloudSchedulerSources) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudSchedulerSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CloudSchedulerSource, err error) {
	result = &v1.CloudSchedulerSource{}
