...
func (c *topics) Get(name string, options v1.GetOptions) (result *v1beta1.Topic, err error) {
...
func (c *topics) List(opts v1.ListOptions) (result *v1beta1.TopicList, err error) {
...
func (c *topics) Create(topic *v1beta1.Topic) (result *v1beta1.Topic, err error) {
	result = &v1beta1.Topic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("topics").
...
func (c *topics) Update(topic *v1beta1.Topic) (result *v1beta1.Topic, err error) {
	result = &v1beta1.Topic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topics").
...
func (c *topics) UpdateStatus(topic *v1beta1.Topic) (result *v1beta1.Topic, err error) {
	result = &v1beta1.Topic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topics").
...
func (c *topics) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Topic, err error) {
	result = &v1beta1.Topic{}
