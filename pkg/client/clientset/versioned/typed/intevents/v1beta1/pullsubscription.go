...
type PullSubscriptionInterface interface {
	Create(ctx context.Context, pullSubscription *v1beta1.PullSubscription, opts v1.CreateOptions) (*v1beta1.PullSubscription, error)
	Update(ctx context.Context, pullSubscription *v1beta1.PullSubscription, opts v1.UpdateOptions) (*v1beta1.PullSubscription, error)
	UpdateStatus(ctx context.Context, pullSubscription *v1beta1.PullSubscription, opts v1.UpdateOptions) (*v1beta1.PullSubscription, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.PullSubscription, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.PullSubscriptionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PullSubscription, err error)
...
func newPullSubscriptions(c *InternalV1beta1Client, namespace string) *pullSubscriptions {
...
func (c *pullSubscriptions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *pullSubscriptions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PullSubscriptionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.PullSubscriptionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pullsubscriptions").
...
func (c *pullSubscriptions) Create(ctx context.Context, pullSubscription *v1beta1.PullSubscription, opts v1.CreateOptions) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pullsubscriptions").
...
func (c *pullSubscriptions) Update(ctx context.Context, pullSubscription *v1beta1.PullSubscription, opts v1.UpdateOptions) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pullsubscriptions").
...
func (c *pullSubscriptions) UpdateStatus(ctx context.Context, pullSubscription *v1beta1.PullSubscription, opts v1.UpdateOptions) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pullsubscriptions").
...
func (c *pullSubscriptions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
