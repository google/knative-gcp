...
func (c *pullSubscriptions) Get(name string, options v1.GetOptions) (result *v1beta1.PullSubscription, err error) {
...
func (c *pullSubscriptions) List(opts v1.ListOptions) (result *v1beta1.PullSubscriptionList, err error) {
...
func (c *pullSubscriptions) Create(pullSubscription *v1beta1.PullSubscription) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pullsubscriptions").
...
func (c *pullSubscriptions) Update(pullSubscription *v1beta1.PullSubscription) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pullsubscriptions").
...
func (c *pullSubscriptions) UpdateStatus(pullSubscription *v1beta1.PullSubscription) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pullsubscriptions").
...
func (c *pullSubscriptions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.PullSubscription, err error) {
	result = &v1beta1.PullSubscription{}
