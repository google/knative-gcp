...
var brokercellsResource = schema.GroupVersionResource{Group: "internal.events.cloud.google.com", Version: "v1alpha1", Resource: "brokercells"}
...
func (c *FakeBrokerCells) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BrokerCell, err error) {
	...
	return obj.(*v1alpha1.BrokerCell), err
}
...
func (c *FakeBrokerCells) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BrokerCellList, err error) {
	...
	list := &v1alpha1.BrokerCellList{ListMeta: obj.(*v1alpha1.BrokerCellList).ListMeta}
	for _, item := range obj.(*v1alpha1.BrokerCellList).Items {
