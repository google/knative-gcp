...
var eventpolicybindingsResource = schema.GroupVersionResource{Group: "policy.run.cloud.google.com", Version: "v1alpha1", Resource: "eventpolicybindings"}

var eventpolicybindingsKind = schema.GroupVersionKind{Group: "policy.run.cloud.google.com", Version: "v1alpha1", Kind: "EventPolicyBinding"}
...
func (c *FakeEventPolicyBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.EventPolicyBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(eventpolicybindingsResource, c.ns, name), &v1alpha1.EventPolicyBinding{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EventPolicyBinding), err
}
...
func (c *FakeEventPolicyBindings) List(opts v1.ListOptions) (result *v1alpha1.EventPolicyBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(eventpolicybindingsResource, eventpolicybindingsKind, c.ns, opts), &v1alpha1.EventPolicyBindingList{})
	...
	list := &v1alpha1.EventPolicyBindingList{ListMeta: obj.(*v1alpha1.EventPolicyBindingList).ListMeta}
	for _, item := range obj.(*v1alpha1.EventPolicyBindingList).Items {
...
func (c *FakeEventPolicyBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(eventpolicybindingsResource, c.ns, opts))
...
func (c *FakeEventPolicyBindings) Create(eventPolicyBinding *v1alpha1.EventPolicyBinding) (result *v1alpha1.EventPolicyBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(eventpolicybindingsResource, c.ns, eventPolicyBinding), &v1alpha1.EventPolicyBinding{})
...
func (c *FakeEventPolicyBindings) Update(eventPolicyBinding *v1alpha1.EventPolicyBinding) (result *v1alpha1.EventPolicyBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(eventpolicybindingsResource, c.ns, eventPolicyBinding), &v1alpha1.EventPolicyBinding{})
...
func (c *FakeEventPolicyBindings) UpdateStatus(eventPolicyBinding *v1alpha1.EventPolicyBinding) (*v1alpha1.EventPolicyBinding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(eventpolicybindingsResource, "status", c.ns, eventPolicyBinding), &v1alpha1.EventPolicyBinding{})
...
func (c *FakeEventPolicyBindings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(eventpolicybindingsResource, c.ns, name), &v1alpha1.EventPolicyBinding{})
...
func (c *FakeEventPolicyBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(eventpolicybindingsResource, c.ns, listOptions)

	_, err := c.Fake.Invokes(action, &v1alpha1.EventPolicyBindingList{})
	return err
}
...
func (c *FakeEventPolicyBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.EventPolicyBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(eventpolicybindingsResource, c.ns, name, pt, data, subresources...), &v1alpha1.EventPolicyBinding{})
