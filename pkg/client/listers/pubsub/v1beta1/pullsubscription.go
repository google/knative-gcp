...
// List lists all PullSubscriptions in the indexer.
func (s *pullSubscriptionLister) List(selector labels.Selector) (ret []*v1beta1.PullSubscription, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.PullSubscription))
	})
	return ret, err
}
...
// List lists all PullSubscriptions in the indexer for a given namespace.
func (s pullSubscriptionNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.PullSubscription, err error) {
...
// Get retrieves the PullSubscription from the indexer for a given namespace and name.
func (s pullSubscriptionNamespaceLister) Get(name string) (*v1beta1.PullSubscription, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("pullsubscription"), name)
	}
	return obj.(*v1beta1.PullSubscription), nil
}
