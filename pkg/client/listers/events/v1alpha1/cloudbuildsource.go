...
type CloudBuildSourceLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.CloudBuildSource, err error)
...
// List lists all CloudBuildSources in the indexer.
func (s *cloudBuildSourceLister) List(selector labels.Selector) (ret []*v1alpha1.CloudBuildSource, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.CloudBuildSource))
	})
	return ret, err
}
...
type CloudBuildSourceNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.CloudBuildSource, error)
...
// List lists all CloudBuildSources in the indexer for a given namespace.
func (s cloudBuildSourceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.CloudBuildSource, err error) {
...
// Get retrieves the CloudBuildSource from the indexer for a given namespace and name.
func (s cloudBuildSourceNamespaceLister) Get(name string) (*v1alpha1.CloudBuildSource, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("cloudbuildsource"), name)
	}
	return obj.(*v1alpha1.CloudBuildSource), nil
}
