...
// List lists all CloudAuditLogsSources in the indexer.
func (s *cloudAuditLogsSourceLister) List(selector labels.Selector) (ret []*v1beta1.CloudAuditLogsSource, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.CloudAuditLogsSource))
	})
	return ret, err
}
...
// List lists all CloudAuditLogsSources in the indexer for a given namespace.
func (s cloudAuditLogsSourceNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.CloudAuditLogsSource, err error) {
...
// Get retrieves the CloudAuditLogsSource from the indexer for a given namespace and name.
func (s cloudAuditLogsSourceNamespaceLister) Get(name string) (*v1beta1.CloudAuditLogsSource, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("cloudauditlogssource"), name)
	}
	return obj.(*v1beta1.CloudAuditLogsSource), nil
}
