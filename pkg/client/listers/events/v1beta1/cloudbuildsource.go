...
// List lists all CloudBuildSources in the indexer.
func (s *cloudBuildSourceLister) List(selector labels.Selector) (ret []*v1beta1.CloudBuildSource, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.CloudBuildSource))
	})
	return ret, err
}
...
// List lists all CloudBuildSources in the indexer for a given namespace.
func (s cloudBuildSourceNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.CloudBuildSource, err error) {
...
// Get retrieves the CloudBuildSource from the indexer for a given namespace and name.
func (s cloudBuildSourceNamespaceLister) Get(name string) (*v1beta1.CloudBuildSource, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("cloudbuildsource"), name)
	}
	return obj.(*v1beta1.CloudBuildSource), nil
}
