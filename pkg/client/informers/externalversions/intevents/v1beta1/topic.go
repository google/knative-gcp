	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InternalV1beta1().Topics(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InternalV1beta1().Topics(namespace).Watch(context.TODO(), options)
			},
		},
		&inteventsv1beta1.Topic{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *topicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&inteventsv1beta1.Topic{}, f.defaultInformer)
}

func (f *topicInformer) Lister() v1beta1.TopicLister {
	return v1beta1.NewTopicLister(f.Informer().GetIndexer())
}
