	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.InternalV1().Topics(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InternalV1().Topics(namespace).Watch(context.TODO(), options)
			},
		},
		&inteventsv1.Topic{},
		resyncPeriod,
...
func (f *topicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&inteventsv1.Topic{}, f.defaultInformer)
}
