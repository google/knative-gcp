	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1alpha1().EventPolicyBindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().EventPolicyBindings(namespace).Watch(options)
			},
		},
		&policyv1alpha1.EventPolicyBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventPolicyBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyv1alpha1.EventPolicyBinding{}, f.defaultInformer)
}
