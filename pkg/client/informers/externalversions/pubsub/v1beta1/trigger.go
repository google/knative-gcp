	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PubsubV1beta1().Triggers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PubsubV1beta1().Triggers(namespace).Watch(options)
			},
		},
		&pubsubv1beta1.Trigger{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *triggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pubsubv1beta1.Trigger{}, f.defaultInformer)
}
