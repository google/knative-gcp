...
type CloudAuditLogsSourceInformer interface {
	...
	Lister() v1.CloudAuditLogsSourceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1().CloudAuditLogsSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1().CloudAuditLogsSources(namespace).Watch(context.TODO(), options)
			},
		},
		&eventsv1.CloudAuditLogsSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cloudAuditLogsSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1.CloudAuditLogsSource{}, f.defaultInformer)
}

func (f *cloudAuditLogsSourceInformer) Lister() v1.CloudAuditLogsSourceLister {
	return v1.NewCloudAuditLogsSourceLister(f.Informer().GetIndexer())
}
