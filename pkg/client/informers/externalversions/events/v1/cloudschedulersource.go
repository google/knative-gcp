...
type CloudSchedulerSourceInformer interface {
	...
	Lister() v1.CloudSchedulerSourceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1().CloudSchedulerSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1().CloudSchedulerSources(namespace).Watch(context.TODO(), options)
			},
		},
		&eventsv1.CloudSchedulerSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cloudSchedulerSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1.CloudSchedulerSource{}, f.defaultInformer)
}

func (f *cloudSchedulerSourceInformer) Lister() v1.CloudSchedulerSourceLister {
	return v1.NewCloudSchedulerSourceLister(f.Informer().GetIndexer())
}
