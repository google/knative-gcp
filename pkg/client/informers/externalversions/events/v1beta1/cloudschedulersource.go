	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1beta1().CloudSchedulerSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1beta1().CloudSchedulerSources(namespace).Watch(context.TODO(), options)
			},
		},
		&eventsv1beta1.CloudSchedulerSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cloudSchedulerSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1beta1.CloudSchedulerSource{}, f.defaultInformer)
}

func (f *cloudSchedulerSourceInformer) Lister() v1beta1.CloudSchedulerSourceLister {
	return v1beta1.NewCloudSchedulerSourceLister(f.Informer().GetIndexer())
}
