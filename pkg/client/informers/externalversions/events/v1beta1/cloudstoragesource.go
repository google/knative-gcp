...
func (f *cloudStorageSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1beta1.CloudStorageSource{}, f.defaultInformer)
}

func (f *cloudStorageSourceInformer) Lister() v1beta1.CloudStorageSourceLister {
	return v1beta1.NewCloudStorageSourceLister(f.Informer().GetIndexer())
}
