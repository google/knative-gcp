	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1beta1().CloudAuditLogsSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1beta1().CloudAuditLogsSources(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cloudAuditLogsSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1beta1.CloudAuditLogsSource{}, f.defaultInformer)
}

func (f *cloudAuditLogsSourceInformer) Lister() v1beta1.CloudAuditLogsSourceLister {
	return v1beta1.NewCloudAuditLogsSourceLister(f.Informer().GetIndexer())
}
