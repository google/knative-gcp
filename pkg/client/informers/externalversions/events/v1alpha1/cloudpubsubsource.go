	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1alpha1().CloudPubSubSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1alpha1().CloudPubSubSources(namespace).Watch(context.TODO(), options)
			},
		},
		&eventsv1alpha1.CloudPubSubSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cloudPubSubSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1alpha1.CloudPubSubSource{}, f.defaultInformer)
}

func (f *cloudPubSubSourceInformer) Lister() v1alpha1.CloudPubSubSourceLister {
	return v1alpha1.NewCloudPubSubSourceLister(f.Informer().GetIndexer())
}
