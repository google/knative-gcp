	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1alpha1().Channels(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1alpha1().Channels(namespace).Watch(options)
			},
		},
		&eventsv1alpha1.Channel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *channelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1alpha1.Channel{}, f.defaultInformer)
}
