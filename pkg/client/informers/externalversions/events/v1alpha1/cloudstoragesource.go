	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1alpha1().CloudStorageSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1alpha1().CloudStorageSources(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cloudStorageSourceInformer) Lister() v1alpha1.CloudStorageSourceLister {
