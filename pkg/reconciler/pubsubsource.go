...
//	"github.com/GoogleCloudPlatform/knative-eventing-sources/contrib/gcppubsub/pkg/apis/sources/v1alpha1"
//	"github.com/GoogleCloudPlatform/knative-eventing-sources/contrib/gcppubsub/pkg/reconciler/resources"
//	"github.com/GoogleCloudPlatform/knative-eventing-sources/pkg/controller/sdk"
//	"github.com/GoogleCloudPlatform/knative-eventing-sources/pkg/controller/sinks"
...
//	controllerAgentName = "eventing-pubsub-source-controller"
//
...
//// unit tests.
//func gcpPubSubClientCreator(ctx context.Context, googleCloudProject string) (pkg.pubSubClient, error) {
...
//		return nil, err
//	}
//	return &pkg.realGcpPubSubClient{
//		client: psc,
//	}, nil
//}
//
...
//}
//
//func (r *reconciler) createReceiveAdapter(ctx context.Context, src *v1alpha1.PubSub, subscriptionID, sinkURI string) (*v1.Deployment, error) {
...
//}
//
//func (r *reconciler) getReceiveAdapter(ctx context.Context, src *v1alpha1.PubSub) (*v1.Deployment, error) {
...
//}
//
//func (r *reconciler) getLabelSelector(src *v1alpha1.PubSub) labels.Selector {
//	return labels.SelectorFromSet(getLabels(src))
//}
//
//func getLabels(src *v1alpha1.PubSub) map[string]string {
...
//}
//
//func (r *reconciler) reconcileEventTypes(ctx context.Context, src *v1alpha1.PubSub) error {
...
//}
//
//func generateSubName(src *v1alpha1.PubSub) string {
