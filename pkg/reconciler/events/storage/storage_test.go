	...
	table := TableTest{{
		...
		},
		{
			...
			Objects: []runtime.Object{
				...
				NewPubSubTrigger(storageName, testNS,
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewCloudStorageSource(storageName, testNS,
					...
					WithCloudStorageSourceTriggerReady(),
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewCloudStorageSource(storageName, testNS,
					...
					WithCloudStorageSourceTriggerFailed("TriggerDeleted", fmt.Sprintf("Successfully deleted Trigger: %s", storageName)),
					WithDeletionTimestamp()),
			}},
		}}
