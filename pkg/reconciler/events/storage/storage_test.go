	...
	table := TableTest{{
		...
		},
		{
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				...
				reconcilertestingv1.WithCloudStorageSourceEventTypes([]string{schemasv1.CloudStorageObjectFinalizedEventType}),
				reconcilertestingv1.WithCloudStorageSourceObjectMetaGeneration(generation),
				reconcilertestingv1.WithCloudStorageSourceNotificationNotReady(deleteNotificationFailed,
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: reconcilertestingv1.NewCloudStorageSource(storageName, testNS,
					...
					reconcilertestingv1.WithCloudStorageSourceEventTypes([]string{schemasv1.CloudStorageObjectFinalizedEventType}),
					reconcilertestingv1.WithCloudStorageSourceObjectMetaGeneration(generation),
					reconcilertestingv1.WithCloudStorageSourceNotificationNotReady("NotificationFinalized", "Bucket does not exist."),
					reconcilertestingv1.WithCloudStorageSourceNotificationID(notificationId),
					reconcilertestingv1.WithCloudStorageSourceTopicFailed("TopicDeleted", fmt.Sprintf("Successfully deleted Topic: %s", storageName)),
					reconcilertestingv1.WithCloudStorageSourcePullSubscriptionFailed("PullSubscriptionDeleted", fmt.Sprintf("Successfully deleted PullSubscription: %s", storageName)),
					reconcilertestingv1.WithDeletionTimestamp,
					reconcilertestingv1.WithCloudStorageSourceSetDefaults,
				),
			}},
		},
		{
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: reconcilertestingv1.NewCloudStorageSource(storageName, testNS,
					...
					reconcilertestingv1.WithCloudStorageSourceEventTypes([]string{schemasv1.CloudStorageObjectFinalizedEventType}),
					reconcilertestingv1.WithCloudStorageSourceObjectMetaGeneration(generation),
					reconcilertestingv1.WithCloudStorageSourceNotificationNotReady("NotificationDeleted", fmt.Sprintf("Successfully deleted notification: %s.", notificationId)),
					reconcilertestingv1.WithCloudStorageSourceNotificationID(notificationId),
					reconcilertestingv1.WithCloudStorageSourceTopicFailed("TopicDeleted", fmt.Sprintf("Successfully deleted Topic: %s", storageName)),
					reconcilertestingv1.WithCloudStorageSourcePullSubscriptionFailed("PullSubscriptionDeleted", fmt.Sprintf("Successfully deleted PullSubscription: %s", storageName)),
					reconcilertestingv1.WithDeletionTimestamp,
