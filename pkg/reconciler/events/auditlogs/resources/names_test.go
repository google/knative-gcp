...
func TestGenerateTopicName(t *testing.T) {
	...
	got := GenerateTopicName(&v1beta1.CloudAuditLogsSource{
...
func TestGenerateTopicResourceName(t *testing.T) {
	...
	got := GenerateTopicResourceName(&v1beta1.CloudAuditLogsSource{
...
func TestGenerateSinkName(t *testing.T) {
	want := "cre-src_mynamespace_myname_uid"
	got := GenerateSinkName(&v1beta1.CloudAuditLogsSource{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "myname",
			Namespace: "mynamespace",
			UID:       "uid",
