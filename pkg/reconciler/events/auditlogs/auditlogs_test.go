	...
	table := TableTest{{
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewAuditLogsSource(sourceName, testNS,
				WithAuditLogsSourceFinalizers(finalizerName),
				WithInitAuditLogsSourceConditions,
				WithAuditLogsSourceTopicFalse("TopicNotReady", `Topic "test-auditlogssource" did not expose projectid`),
			),
		}},
		WantEvents: []string{
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewAuditLogsSource(sourceName, testNS,
				WithAuditLogsSourceFinalizers(finalizerName),
				WithInitAuditLogsSourceConditions,
				WithAuditLogsSourceTopicFalse("TopicNotReady", `Topic "test-auditlogssource" did not expose topicid`),
			),
		}},
		WantEvents: []string{
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewAuditLogsSource(sourceName, testNS,
				WithAuditLogsSourceFinalizers(finalizerName),
				WithInitAuditLogsSourceConditions,
				WithAuditLogsSourceTopicFalse("TopicNotReady", `Topic "test-auditlogssource" mismatch: expected "auditlogssource-test-auditlogssource-uid" got "garbaaaaage"`),
			),
		}},
		WantEvents: []string{
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewAuditLogsSource(sourceName, testNS,
				WithAuditLogsSourceFinalizers(finalizerName),
				WithInitAuditLogsSourceConditions,
				WithAuditLogsSourceTopicFalse("PublisherStatus", "Publisher has no Ready type status")),
		}},
		WantEvents: []string{
		...
		Objects: []runtime.Object{
			...
			NewPullSubscriptionWithNoDefaults(sourceName, testNS, WithPullSubscriptionFalse()),
		},
		Key:     testNS + "/" + sourceName,
		WantErr: true,
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewAuditLogsSource(sourceName, testNS,
				...
				WithInitAuditLogsSourceConditions,
				WithAuditLogsSourceTopicReady(testTopicID),
				WithAuditLogsSourcePullSubscriptionFalse("InvalidSink", `failed to get ref &ObjectReference{Kind:Sink,Namespace:testnamespace,Name:sink,UID:,APIVersion:testing.cloud.google.com/v1alpha1,ResourceVersion:,FieldPath:,}: sinks.testing.cloud.google.com "sink" not found`),
			),
		}},
		WantEvents: []string{
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewAuditLogsSource(sourceName, testNS,
				...
				WithAuditLogsSourceTopicFalse("TopicDeleted", fmt.Sprintf("Successfully deleted Topic: %s", sourceName)),
				WithAuditLogsSourcePullSubscriptionFalse("PullSubscriptionDeleted", fmt.Sprintf("Successfully deleted PullSubscription: %s", sourceName)),
				WithAuditLogsSourceDeletionTimestamp,
			),
		}},
