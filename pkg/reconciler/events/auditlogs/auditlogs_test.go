...
func TestAllCases(t *testing.T) {
	...
	table := TableTest{{
		...
		Objects: []runtime.Object{
			...
			NewPubSubTrigger(sourceName, testNS,
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewCloudAuditLogsSource(sourceName, testNS,
				...
				WithCloudAuditLogsSourceTriggerReady(),
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewCloudAuditLogsSource(sourceName, testNS,
				...
				WithCloudAuditLogsSourceTriggerFailed("TriggerDeleted", fmt.Sprintf("Successfully deleted Trigger: %s", sourceName)),
				WithCloudAuditLogsSourceDeletionTimestamp,
			),
		}},
