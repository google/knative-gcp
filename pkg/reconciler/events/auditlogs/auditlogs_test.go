	...
	table := TableTest{{
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: v1.NewCloudAuditLogsSource(sourceName, testNS,
				...
				v1.WithCloudAuditLogsSourceProjectID(testProject),
				v1.WithInitCloudAuditLogsSourceConditions,
				v1.WithCloudAuditLogsSourceSinkNotReady(deleteSinkFailed, fmt.Sprintf("%s: delete-sink-induced-error", failedToDeleteSinkMsg)),
				v1.WithCloudAuditLogsSourceSinkURI(calSinkURL),
				v1.WithCloudAuditLogsSourceSinkID(testSinkID),
				v1.WithCloudAuditLogsSourceTopicReady(testTopicID),
				v1.WithCloudAuditLogsSourcePullSubscriptionReady(),
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: v1.NewCloudAuditLogsSource(sourceName, testNS,
				...
				v1.WithCloudAuditLogsSourceSink(sinkGVK, sinkName),
				v1.WithInitCloudAuditLogsSourceConditions,
				v1.WithCloudAuditLogsSourceSinkNotReady("SinkDeleted", fmt.Sprintf("Sink successfully deleted: %s", testSinkID)),
				v1.WithCloudAuditLogsSourceTopicFailed("TopicDeleted", fmt.Sprintf("Successfully deleted Topic: %s", sourceName)),
				v1.WithCloudAuditLogsSourcePullSubscriptionFailed("PullSubscriptionDeleted", fmt.Sprintf("Successfully deleted PullSubscription: %s", sourceName)),
				v1.WithCloudAuditLogsSourceDeletionTimestamp,
				v1.WithCloudAuditLogsSourceSetDefaults,
			),
		}},
