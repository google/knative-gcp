	...
	table := TableTest{{
	...
	},
		{
			...
			Objects: []runtime.Object{
				...
				NewPubSubTrigger(schedulerName, testNS,
					WithPubSubTriggerTriggerReady(testTopicID),
				),
				newSink(),
			},
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewCloudSchedulerSource(schedulerName, testNS,
					...
					WithCloudSchedulerSourceTriggerReady(),
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewCloudSchedulerSource(schedulerName, testNS,
					...
					WithCloudSchedulerSourceTriggerFailed("TriggerDeleted", fmt.Sprintf("Successfully deleted Trigger: %s", schedulerName)),
					WithCloudSchedulerSourceDeletionTimestamp,
				),
			}},
			WantDeletes: []clientgotesting.DeleteActionImpl{
				...
				{ActionImpl: clientgotesting.ActionImpl{
					Namespace: testNS, Verb: "delete", Resource: schema.GroupVersionResource{Group: "pubsub.cloud.google.com", Version: "v1alpha1", Resource: "triggers"}},
					Name: schedulerName,
				},
			},
			OtherTestData: map[string]interface{}{
