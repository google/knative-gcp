	...
	table := TableTest{{
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewPubSub(pubsubName, testNS,
				...
				WithPubSubObjectMetaGeneration(generation),
				WithPubSubFinalizers(finalizerName),
				WithPubSubPullSubscriptionUnknown("PullSubscriptionNotConfigured", "PullSubscription has not yet been reconciled"),
			),
		}},
		...
		WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
			Object: NewPubSub(pubsubName, testNS,
				...
				WithInitPubSubConditions,
				WithPubSubObjectMetaGeneration(generation),
				WithPubSubPullSubscriptionUnknown("PullSubscriptionUnknown", "status unknown test message"),
			),
		}},
		WantEvents: []string{
			Eventf(corev1.EventTypeNormal, "Updated", "Updated PubSub %q", pubsubName),
