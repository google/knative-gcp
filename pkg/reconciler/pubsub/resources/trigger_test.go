...
func TestMakeTriggerWithCloudStorageSource(t *testing.T) {
	...
	got := MakeTrigger(args)

	yes := true
	want := &pubsubv1alpha1.Trigger{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "storage-namespace",
			Name:      "storage-name",
			Labels: map[string]string{
...
func TestMakeTriggerWithCloudSchedulerSource(t *testing.T) {
