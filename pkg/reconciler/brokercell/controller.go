...
import (
	...
	namespacedsecretinformer "github.com/google/knative-gcp/pkg/injection/namespacedsecret"
...
func NewController(
	...
	namespacedSecretInformer := namespacedsecretinformer.Get(injection.WithNamespaceScope(ctx, system.Namespace()))
	...
	ls := listers{
		...
		secretLister:         namespacedSecretInformer.Lister(),
	...
	namespacedSecretInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
