...
const (
	...
	CloudStorageSourceConverter = "com.google.cloud.storage"
)

func convertCloudStorageSource(ctx context.Context, msg *cepubsub.Message, sendMode ModeType) (*cloudevents.Event, error) {
	if msg == nil {
